...
public class Loan extends javax.swing.JFrame {
     ...
     */
    public void updateLoanDB() {
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            sqlConn = DriverManager.getConnection(conn, username, password);
            pst = sqlConn.prepareStatement("select * from banking.loan");
            ...
            DefaultTableModel defaultTableModel = (DefaultTableModel) loanTable.getModel();
    ...
    private void initComponents() {
        ...
        BranchCityLabel.setText("Loan Number");

        BranchAssetsLabel.setText("Loan Amount");
        ...
        loanTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "loan_number", "loan_amount", "branch_id"
            }
        ));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(BranchIDLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(branchIDTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(loanNumTxt, javax.swing.GroupLayout.DEFAULT_SIZE, 200, Short.MAX_VALUE)
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            sqlConn = DriverManager.getConnection(conn, username, password);
            pst = sqlConn.prepareStatement("insert into banking.loan(loan_number, loan_amount, branch_id)value(?,?,?)");

            pst.setString(1, loanNumTxt.getText());
            pst.setString(2, loanAmountTxt.getText());
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            sqlConn = DriverManager.getConnection(conn, username, password);
            pst = sqlConn.prepareStatement("UPDATE banking.loan SET loan_amount = ?, branch_id = ? WHERE (loan_number = ?)");

            pst.setString(1, loanAmountTxt.getText());
            pst.setString(2, branchIDTxt.getText());
            pst.setString(3, loanNumTxt.getText());
    ...
    private void loanTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loanTableMouseClicked
        DefaultTableModel defaultTableModel = (DefaultTableModel) loanTable.getModel();
        int selectedRows = loanTable.getSelectedRow();

        
        loanNumTxt.setText(defaultTableModel.getValueAt(selectedRows, 0).toString());
        loanAmountTxt.setText(defaultTableModel.getValueAt(selectedRows, 1).toString());
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            sqlConn = DriverManager.getConnection(conn, username, password);
            pst = sqlConn.prepareStatement("delete from banking.loan where loan_number=?");
